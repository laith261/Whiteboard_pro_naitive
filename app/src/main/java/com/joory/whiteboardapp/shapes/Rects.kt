...
class Rects : Shape {
    ...
    override fun drawSelectedBox(
        ...
        canvas.withRotation(rotation, cx, cy) {
            ...
            // Draw resize handle
            if (resizeBmp != null) {
                drawCircle(rect.right + offset, rect.bottom + offset, radius, btnBgPaint)
                val dstRect =
                        RectF(
                ...
                drawCircle(rect.right + offset, rect.bottom + offset, smRadius, selectedPaint)
            }

            // Draw rotate handle
            if (rotateBmp != null) {
                drawCircle(rect.left - offset, rect.bottom + offset, radius, btnBgPaint)
                val dstRect =
                        RectF(
            ...
            if (deleteBmp != null) {
                drawCircle(rect.left - offset, rect.top - offset, radius, btnBgPaint)
                val dstRect =
                        RectF(
                                rect.left - offset - 20 * s,
            ...
            if (duplicateBmp != null) {
                drawCircle(rect.right + offset, rect.top - offset, radius, btnBgPaint)
                val dstRect =
                        RectF(
                                rect.right + offset - 20 * s,
                                rect.top - offset - 20 * s,
